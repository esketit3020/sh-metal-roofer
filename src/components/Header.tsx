      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex sm:hidden items-center gap-2">
            <a
              href={`tel:${BUSINESS_INFO.phoneRaw}`}
              className="flex items-center gap-1.5 px-3 py-1.5 rounded bg-[#C81D25] text-white font-bold text-xs"
            >
        ...
        <div className="lg:hidden bg-[#16181d] border-b border-stone-800 px-4 pt-3 pb-6 space-y-3">
          ...
          <div className="pt-4 border-t border-stone-800 flex flex-col gap-2.5">
            ...
            <a
              href={`tel:${BUSINESS_INFO.phoneRaw}`}
              onClick={() => setMobileMenuOpen(false)}
              className="flex items-center justify-center gap-2 py-3 rounded-md bg-[#C81D25] hover:bg-[#A8151D] text-white font-bold text-sm tracking-wide shadow-md"
            >
